...
namespace OpenCVForUnityExample.DnnModel
{
    ...
    /// </summary>
    public class MediaPipePersonDetectorDMT
    {
        float nms_threshold;
        ...
        public MediaPipePersonDetectorDMT(string modelFilepath, float nmsThreshold = 0.3f, float scoreThreshold = 0.5f, int topK = 1, int backend = Dnn.DNN_BACKEND_OPENCV, int target = Dnn.DNN_TARGET_CPU)
        {
            // initialize
