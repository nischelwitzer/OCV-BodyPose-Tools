...
namespace OpenCVForUnityExample
{
    ...
    public class PoseEstimationDrawDMT : MonoBehaviour
    {
        ...
        /// The pose estimator.
        /// </summary>
        MediaPipePoseEstimatorDMT poseEstimator;
        ...
        void Run()
        {
            ...
            {
                personDetector = new MediaPipePersonDetectorDMT(person_detection_model_filepath, 0.3f, 0.6f, 5000);// # usually only one person has good performance
            }
            ...
            {
                poseEstimator = new MediaPipePoseEstimatorDMT(pose_estimation_model_filepath, 0.9f);
            }
        ...
        void Update()
        {
            ...
            if (multiSource2MatHelper.IsPlaying() && multiSource2MatHelper.DidUpdateThisFrame())
            {
                ...
                else
                {
                    ...
                    // nis: loop over all detected persons
                    ...
                    for (int i = 0; i < persons.rows(); ++i)
                    {
                        ...
                        List<Mat> results = poseEstimator.infer(bgrMat, persons.row(i), true);
                    ...
                    personDetector.visualize(rgbaMat, persons, false, true, 
                        ...
                        DMT.StaticStore.showCircleUpperBodyLayer);
