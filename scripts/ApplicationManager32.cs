...
namespace DMT
{
    ...
    public class ApplicationManager32 : MonoBehaviour
    {
        [Space(1, order = 0)]
        [Header("DMT Application Manager with FullHD Configuration", order = 1)]
        [Space(-8, order = 2)]
        [Header("press [h] for Help when running (v3.2)", order = 3)]
        [Space(10, order = 4)]
        ...
        private static ApplicationManager32 instance = null;
        ...
        void Update()
        {
            ...
            if (Input.GetKeyDown("s")) StartCoroutine(TakeScreenShot());
