 ...
 * Version 3.1 - with InfoCanvas, OpenCV, Uduino
 * 
...
namespace DMT
{
    ...
    public class ApplicationManager31 : MonoBehaviour
    {
        [Space(1, order = 0)]
        [Header("DMT Application Manager with FullHD Configuration", order = 1)]
        [Space(-8, order = 2)]
        [Header("press [h] for Help when running (v3.1)", order = 3)]
        [Space(10, order = 4)]
        ...
        private static ApplicationManager31 instance = null;
